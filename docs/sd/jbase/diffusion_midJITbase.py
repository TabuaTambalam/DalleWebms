...
class diffusion_mid(nn.Module):
    def __init__(self):
        ...
        self.output_blocks_0_0_in_layers_1 = nn.SiLU()
        ...
        self.output_blocks_0_0_emb_layers_0 = nn.SiLU()
        ...
        self.output_blocks_0_0_out_layers_1 = nn.SiLU()
        ...
        self.output_blocks_1_0_in_layers_1 = nn.SiLU()
        ...
        self.output_blocks_1_0_out_layers_1 = nn.SiLU()
        ...
        self.output_blocks_2_0_in_layers_1 = nn.SiLU()
        ...
        self.output_blocks_2_0_out_layers_1 = nn.SiLU()
        ...
        self.output_blocks_3_0_in_layers_1 = nn.SiLU()
        ...
        self.output_blocks_3_0_out_layers_1 = nn.SiLU()
        ...
        self.output_blocks_4_0_in_layers_1 = nn.SiLU()
        ...
        self.output_blocks_4_0_out_layers_1 = nn.SiLU()
        ...
        self.output_blocks_5_0_in_layers_1 = nn.SiLU()
        ...
        self.output_blocks_5_0_out_layers_1 = nn.SiLU()
    ...
    def forward(self, v_0, v_1, v_2, v_3, v_4, v_5, v_6, v_7, v_8):
        ...
        v_15=self.output_blocks_0_0_emb_layers_0(v_1)

        v_29 = torch.cat((self.output_blocks_0_0_skip_connection(v_11) + self.output_blocks_0_0_out_layers_3(self.output_blocks_0_0_out_layers_1(self.output_blocks_0_0_out_layers_0 (self.output_blocks_0_0_in_layers_2(self.output_blocks_0_0_in_layers_1(self.output_blocks_0_0_in_layers_0(v_11))) + self.output_blocks_0_0_emb_layers_1(v_15).unsqueeze(2).unsqueeze(3)))), v_7), dim=1)

        v_46 = torch.cat((self.output_blocks_1_0_skip_connection(v_29) + self.output_blocks_1_0_out_layers_3(self.output_blocks_1_0_out_layers_1(self.output_blocks_1_0_out_layers_0(self.output_blocks_1_0_in_layers_2(self.output_blocks_1_0_in_layers_1(self.output_blocks_1_0_in_layers_0(v_29))) + self.output_blocks_1_0_emb_layers_1(v_15).unsqueeze(2).unsqueeze(3)))), v_6), dim=1)

        v_60 = self.output_blocks_2_0_skip_connection(v_46) + self.output_blocks_2_0_out_layers_3(self.output_blocks_2_0_out_layers_1(self.output_blocks_2_0_out_layers_0(self.output_blocks_2_0_in_layers_2(self.output_blocks_2_0_in_layers_1(self.output_blocks_2_0_in_layers_0(v_46))) + self.output_blocks_2_0_emb_layers_1(v_15).unsqueeze(2).unsqueeze(3))))
        v_65 = torch.cat((self.output_blocks_2_1_conv(F.interpolate(input=v_60 , scale_factor=2.0, mode='nearest')), v_5), dim=1)

#===
        v_79 = (self.output_blocks_3_0_skip_connection(v_65) + self.output_blocks_3_0_out_layers_3(self.output_blocks_3_0_out_layers_1(self.output_blocks_3_0_out_layers_0(self.output_blocks_3_0_in_layers_2(self.output_blocks_3_0_in_layers_1(self.output_blocks_3_0_in_layers_0(v_65))) + self.output_blocks_3_0_emb_layers_1(v_15).unsqueeze(2).unsqueeze(3)))))
...
#===
        v_156 = self.output_blocks_4_0_skip_connection(v_142) + self.output_blocks_4_0_out_layers_3(self.output_blocks_4_0_out_layers_1(self.output_blocks_4_0_out_layers_0(self.output_blocks_4_0_in_layers_2(self.output_blocks_4_0_in_layers_1(self.output_blocks_4_0_in_layers_0(v_142))) + self.output_blocks_4_0_emb_layers_1(v_15).unsqueeze(2).unsqueeze(3))))
...
#===
        v_233 = self.output_blocks_5_0_skip_connection(v_219) + self.output_blocks_5_0_out_layers_3(self.output_blocks_5_0_out_layers_1(self.output_blocks_5_0_out_layers_0 (self.output_blocks_5_0_in_layers_2(self.output_blocks_5_0_in_layers_1(self.output_blocks_5_0_in_layers_0(v_219))) + self.output_blocks_5_0_emb_layers_1(v_15).unsqueeze(2).unsqueeze(3))))
